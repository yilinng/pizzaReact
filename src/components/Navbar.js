...
*/ 
	return (
		<div className="navbar sticky top-0 pt-6 px-4 sm:px-6 lg:px-8">
      ...
      <span className="font-mono mr-2">Menu</span>
		...
		<nav className="laptop relative hidden md:block flex items-center justify-between sm:h-10 lg:justify-start">
          ...
          <div className="navbar">
            ...
            <NavLink to="/orderList" className="ml-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">OrderList</NavLink>
  ...
  {/*mobile vr. */}
    {show ? (
      <nav className="mobile shadow-xl py-2">
          ...
          <div className="flex flex-col py-4 px-2">
            ...
            <NavLink to="/orderList" className="py-2 mx-auto font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">OrderList</NavLink>
